...
typedef enum VkStructureType {
    ...
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_GENERIC_DESCRIPTORS_FEATURES_VALVE = 1004000000,
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_GENERIC_DESCRIPTORS_PROPERTIES_VALVE = 1004000001,
...
typedef enum VkDescriptorType {
    ...
    VK_DESCRIPTOR_TYPE_GENERIC_VALVE = 1000200000,
...
typedef enum VkDescriptorBindingFlagBits {
    ...
    VK_DESCRIPTOR_BINDING_GENERIC_SAMPLED_IMAGE_BIT_VALVE = 0x00000010,
    VK_DESCRIPTOR_BINDING_GENERIC_UNIFORM_TEXEL_BUFFER_BIT_VALVE = 0x00000020,
    VK_DESCRIPTOR_BINDING_GENERIC_UNIFORM_BUFFER_BIT_VALVE = 0x00000040,
    VK_DESCRIPTOR_BINDING_GENERIC_STORAGE_BUFFER_BIT_VALVE = 0x00000080,
    VK_DESCRIPTOR_BINDING_GENERIC_STORAGE_IMAGE_BIT_VALVE = 0x00000100,
    VK_DESCRIPTOR_BINDING_GENERIC_STORAGE_TEXEL_BUFFER_BIT_VALVE = 0x00000200,
...
#define VK_VALVE_generic_descriptors 1
#define VK_VALVE_GENERIC_DESCRIPTORS_SPEC_VERSION 1
#define VK_VALVE_GENERIC_DESCRIPTORS_EXTENSION_NAME "VK_VALVE_generic_descriptors"

typedef struct VkPhysicalDeviceGenericDescriptorsFeaturesVALVE {
    VkStructureType    sType;
    void*              pNext;
    VkBool32           genericDescriptors;
} VkPhysicalDeviceGenericDescriptorsFeaturesVALVE;

typedef struct VkPhysicalDeviceGenericDescriptorsPropertiesVALVE {
    VkStructureType            sType;
    void*                      pNext;
    VkDescriptorBindingFlags   supportedGenericBindingFlags;
} VkPhysicalDeviceGenericDescriptorsPropertiesVALVE;
